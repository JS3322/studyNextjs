...
import { ScrollControls, Scroll, useScroll } from './scroll_controll'
...
function Pages() {
    ...
    return (
        <>
            <Page position={[-width * 1, 0, 0]} urls={['/trip1.png', '/trip1.png', '/trip1.png']} />
            <Page position={[width * 0, 0, 0]} urls={['/img1.png', '/img1.png', '/img1.png']} />
            <Page position={[width * 1, 0, 0]} urls={['/img1.png', '/img1.png', '/img1.png']} />
            <Page position={[width * 2, 0, 0]} urls={['/trip1.png', '/trip1.png', '/trip1.png']} />
            <Page position={[width * 3, 0, 0]} urls={['/img1.png', '/img1.png', '/img1.png']} />
            <Page position={[width * 4, 0, 0]} urls={['/img1.png', '/img1.png', '/img1.png']} />
        </>
    )
}
